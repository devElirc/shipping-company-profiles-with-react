...
Keep that data file unchanged and use it as the source for the rendered company profiles. Render one accessible <article> per company using the company name as the article label.
